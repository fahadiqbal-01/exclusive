  ...
  return (
    <section className=" pb-[500px] ">
      <Container>
        <BreadCrumb />
        <div>
          <Flex className=" items-center justify-between px-[40px] py-[24px] reounded-[4px] drop-shadow-md shadow-md">
          ...
          <div className=" mt-[24px] flex items-center justify-between ">
            <button className=" text-[16px] font-poppins font-medium leading-[24px] text-black px-[48px] py-[16px] border-[1px] border-border rounded-[4px] ">
