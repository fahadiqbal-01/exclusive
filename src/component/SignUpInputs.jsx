  ...
  return (
    <div className={className}>
      ...
      <button
        ...
        className=" text-[16px] font-poppins font-medium leading-[24px] text-white px-[122px] py-[16px] bg-[#DB4444] rounded-[4px] "
      >
        Create Account
      </button>
      <br />
      ...
      <div className=" text-[16px] font-poppins font-normal leading-[24px] text-black mt-[32px] flex items-center justify-center ">
        Already have account?{" "}
        <Link
          to="/SignIn"
          className=" font-medium pb-[4px] border-b-[1px] border-[#7D8184] ml-[16px] "
        >
          Log in
        </Link>
      </div>
